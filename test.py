...
UID=os.environ["RDUxQTY4MTI3MzFDQkNGOUQxRDY0N0IzQUVEMTVEMTM="]
SERVERPUSHKEY = SCT187860Tp64n6yeE6r75mLk1XVYXhWqp
MSG_TO = None
if "SERVERPUSHKEY" in os.environ:
    SERVERPUSHKEY = os.environ["SCT187860Tp64n6yeE6r75mLk1XVYXhWqp"]
if "MSG_TO" in os.environ:
    MSG_TO = os.environ["MSG_TO"]

daka(RDUxQTY4MTI3MzFDQkNGOUQxRDY0N0IzQUVEMTVEMTM=, SCT187860Tp64n6yeE6r75mLk1XVYXhWqp, MSG_TO)
